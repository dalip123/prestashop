		...
		<fieldset>
			...
			<div class="clearfix">
				<div class="col-xs-12 col-md-3">
					...
					{/if}
                 <p class="form-group">
					    <label for="extrafield">{l s='Order Through'}</label>
					    {if isset($customerThread.order_t)}
					        <input type="text" class="form-control" id="order_t" name="order_t" value="{$customerThread.order_t|escape:'htmlall':'UTF-8'}" readonly="readonly" />
					    {else}
					        <input type="text" class="form-control" id="order_t" name="order_t" value="" />
					    {/if}
					 </p>
                 <p class="form-group">
					    <label for="phonenumber">{l s='Phone Number'}</label>
					    {if isset($customerThread.phone)}
					        <input type="text" class="form-control" id="phone" name="phone" value="{$customerThread.phone|escape:'htmlall':'UTF-8'}" readonly="readonly" />
					    {else}
